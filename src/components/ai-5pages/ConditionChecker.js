const ConditionChecker = () => {
  return (
    <div className="self-stretch rounded-11xl bg-[#FFFFFF] shadow-2xl box-border flex flex-col items-start justify-start py-[30px] px-7 gap-[30px] max-w-full text-left text-15xl text-black font-poppins border-[2px] border-solid border-gray-200 mq1050:pt-5 mq1050:pb-5 mq1050:box-border">
